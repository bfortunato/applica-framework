...
/**
 * Created by federicomalvasi on 11/07/16.
 */

public abstract class MultiImagesFieldRenderer extends VelocityFormFieldRenderer {
    ...
    public void render(Writer writer, FormField field, Object value) {
        ...
        setTemplatePath("templates/fields/multi_images.vm");
